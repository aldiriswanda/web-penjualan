    ...
    <div class="container col-md-6">
        <div class="card">
            ...
            <form action="" method="POST" class="form-item">
                ...
                <input type="number" name="telp" value="<?php echo $data['telp'] ?>" class="form-control col-md_9" placeholder="Masukkan Telepon">
                </div>
                ...
                <input type="text" name="kota" value="<?php echo $data['kota'] ?>" class="form-control col-md_9" placeholder="Masukkan Kota">
                </div>

                <div class="form-group">
                <label for="kodepos">Kode Pos</label>
                <input type="Number" name="kodepos" value="<?php echo $data['kodepos'] ?>" class="form-control col-md_9" placeholder="Masukkan Kode Pos">
                </div>
